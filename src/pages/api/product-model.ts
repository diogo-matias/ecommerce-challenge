...
const allowedInfos = [
    ...
    },
    {
        ...
        attributes: [
            ...
            {
                name: "Lavável",
                value: "Sim, lavagem manual",
            },
            {
                name: "Ventilação",
                value: "Tecido respirável para maior conforto",
            },
            {
                name: "Compatibilidade",
                value: "Pode ser usada em ambos os punhos",
            },
            {
    ...
    {
        id: "5eefafb8-3cs1-4201-b8eb-36d7e45b2cbb",
...
export class RandomProduct {
    ...
    constructor() {
        ...
        this.product = {
            ...
            brand: "Orthopedic",
            category: this.getRandom(allowedCategories),
    ...
    generateSKU() {
        const randomNum = Math.floor(Math.random() * 1000) + 1050;
