...
export default function ProductPage(props) {
  console.log("PROPRIEDADES ESTÁTICAS", props);
    ...
    <div className={`${raleway.variable} ${roboto.variable}`}>
      ...
      <Layout>
        ...
        <div className="container mx-auto lg:mr-0 max-w-auto lg:max-w-[90vw] mb-10">
          <h1 className="text-3xl text-foreground font-medium  ml-5">
...
//     `http://localhost:3000/api/products/7aasdb2e-2bfc-4a47-ds23asd-b5casd4d2dfbbf1`
//   );
